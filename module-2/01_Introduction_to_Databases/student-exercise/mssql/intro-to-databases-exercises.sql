...
SELECT name, AVG (lifeexpectancy) AS 'Average life expectancy'
FROM country
...
SELECT name, continent, GNP, AVG (lifeexpectancy) AS 'Average life expectancy'
FROM country
...
SELECT name, (2019-indepyear) AS 'Years since independence'
FROM country
