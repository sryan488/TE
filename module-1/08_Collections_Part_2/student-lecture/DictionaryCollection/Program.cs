...
namespace DictionaryCollection
{
    class Program
    {
        ...
        { 
            ////todo is a variable of our main method
            ...
            while (input == "yes" || input == "y")
            {
                ...
                bool exists = nameHeights.ContainsKey(name);    // <-- does it contain the Key?
            ...
            else if (input == "all")
            {
                ...
                //{
                //    Console.WriteLine(k); // this will get you a list of strings
                //}
